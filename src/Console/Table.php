...
class Table
{
     ...
     * @return void
     */
    public function setHeader(array $header, int $align = null): void
    {
        $this->header      = $header;
        $this->headerAlign = (int)$align;
     ...
     * @return void
     */
    public function setRows(array $rows, int $align = null): void
    {
        $this->rows      = $rows;
        $this->cellAlign = (int)$align;
     ...
     * @return $this
     */
    public function setCellAlign(int $align = null)
    {
        $this->cellAlign = (int)$align;
        return $this;
    }
     ...
     * @return void
     */
    public function addRow($row, bool $first = null): void
    {
        if ($first == true) {
    ...
    protected function renderHeader(): string
    {
        ...
        foreach ($this->header as $key => $val) {
            ...
            $array[] = ' ' . str_pad($val, $width, $style[1], $this->headerAlign);
        }
     ...
     * @return string
     */
    public function render(array $dataList = [], int $align = null): string
    {
        if (!empty($dataList)) {
            $this->setRows($dataList,$align);
        }
